...
# from app.rag_pipeline.workflow import flow as workflow_app
from app.text2SQL.process_cvs_sql import process_cvs_sql    
from app.services.extract_cv import process_cv   
from app.rag_pipeline.workflow import build_flow  # graph build sẵn
# from app.rag_pipeline.workflow import flow as app
...
# uvicorn app.api.main2:app --reload --port 8000